    ...
    <Box>
      ...
      <Box boxShadow="inner" p="2" bg="gray.900" color="white">
        <SimpleGrid columns={4}>
          ...
          <Box>
            <NavLink to="/women" style={({ isActive }) => (isActive ? activeStyle : undefined)}>Women</NavLink>
          </Box>
          <Box>
            <NavLink to="/kids" style={({ isActive }) => (isActive ? activeStyle : undefined)}>Kids</NavLink>
          </Box>
          <Box>
            <NavLink to="/beauty" style={({ isActive }) => (isActive ? activeStyle : undefined)}>Beauty</NavLink>
          </Box>
        </SimpleGrid>
      </Box>
    </Box>
